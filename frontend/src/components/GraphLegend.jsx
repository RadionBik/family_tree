...
const EdgeLegendItem = ({ lineStyle, arrow, color = '#ccc', label }) => { // Add color prop with default
...
const GraphLegend = () => {
  ...
  return (
    <div className="graph-legend" style={{ marginTop: '20px', padding: '15px', border: '1px solid #eee', backgroundColor: '#f9f9f9' }}>
      <h4>{t('familyTree.edgeLegendTitle', 'Edge Types')}</h4> {/* Changed title key */}
      ...
      <EdgeLegendItem lineStyle="solid" arrow={true} color="#28a745" label={t('relationType.parent-child', 'Parent-Child')} />
      <EdgeLegendItem lineStyle="dashed" arrow={false} color="#fd7e14" label={t('relationType.spouse', 'Spouse')} />
